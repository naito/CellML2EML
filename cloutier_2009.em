...
# from file: cloutier_2009.eml, date: Tue Sep  1 11:21:23 2015
#
...
System System( /ATPn )
{
	...
	{
		Name	__none__;
		Expression	"( Vn_pgk.Value + Vn_pk.Value + nOP.Value * Vn_mito.Value + Vn_ck.Value - ( Vn_hk.Value + Vn_pfk.Value + Vn_ATPase.Value + Vn_pump.Value ) ) * pow( 1 - dAMP_dATPn.Value, -1 )";
		VariableReferenceList
			[ ATPn       :/ATPn:ATPn             1 ]
...
System System( /v_stim )
{
	...
	{
		Name	__none__;
		Expression	"stim.Value * ( v1_n.Value + v2_n.Value * ( <t> - to.Value ) / t_n_stim.Value * exp( -( ( <t> - to.Value ) * unitpulseSB.Value / t_n_stim.Value ) ) ) * unitpulseSB.Value";
		VariableReferenceList
	...
	{
		Name	__none__;
		Expression	"piecewise( 1, and( geq( <t>, to.Value ), leq( <t>, to.Value + tend.Value ) ), 0 )";
		VariableReferenceList
...
System System( /unitstepSB )
{
	...
	{
		Name	__none__;
		Expression	"piecewise( 1, geq( <t> - ( tend.Value + to.Value ), 0 ), 0 )";
		VariableReferenceList
...
System System( /Fin_t )
{
	...
	{
		Name	__none__;
		Expression	"CBF0.Value + stim.Value * CBF0.Value * deltaf.Value * 1 / ( 1 + exp( 1 * -sr.Value * ( <t> - ( to.Value + t1.Value - 3 ) ) ) ) - stim.Value * CBF0.Value * deltaf.Value * 1 / ( 1 + exp( 1 * -sr.Value * ( <t> - ( to.Value + tend.Value + t1.Value + 3 ) ) ) )";
		VariableReferenceList
			[ Fin_t  :/Fin_t:Fin_t             1 ]
			[ CBF0   :/Fin_t:CBF0              0 ]
			[ stim   :/model_parameters:stim   0 ]
...
System System( /unitstepSB2 )
{
	...
	{
		Name	__none__;
		Expression	"piecewise( 1, geq( <t> - ( tend_GLY.Value + to.Value + to_GLY.Value ), 0 ), 0 )";
		VariableReferenceList
...
System System( /Vg_glyp )
{
	...
	{
		Name	__none__;
		Expression	"1 + stim.Value * delta_GLY.Value * KO3.Value * 1 / ( 1 + exp( 1 * -sr_GLY.Value * ( <t> - ( to.Value + to_GLY.Value ) ) ) ) * ( 1 - unitstepSB2.Value )";
		VariableReferenceList
